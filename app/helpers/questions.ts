const questions = [
  {
    ...
    questions: [
      ...
      "Are there any exclusions or exceptions to the confidentiality obligations?",
      "What jurisdiction's laws will govern the agreement?",
    ],
  },
  {
    ...
    questions: [
      ...
      "What happens in case of termination or breach of the agreement?",
    ],
  },
  {
    ...
    questions: [
      ...
      "What are the terms for termination, including notice periods and severance?",
    ],
  },
  {
    ...
    questions: [
      ...
      "Are there any intellectual property rights or confidentiality clauses?",
      "How will disputes be resolved, and what are the termination conditions?",
    ],
  },
  {
    ...
    questions: [
      ...
      "Are there any warranties or guarantees for the product?",
      "What are the rights and obligations of both parties regarding returns, refunds, and disputes?",
    ],
  },
  {
    ...
    questions: [
      ...
      "What are the terms for the return on investment, such as dividends or exit strategies?",
      "Are there any provisions for additional funding rounds or dilution of ownership?",
    ],
  },
  {
    ...
    questions: [
      ...
      "What are the conditions for making claims and the process for claim settlements?",
  ...
  },
  {
    ...
    questions: [
      ...
      "Are there any provisions for renewal, termination, or subleasing?",
      "What are the responsibilities of both parties regarding maintenance, repairs, and insurance?",
    ],
  },
  {
    ...
    questions: [
      ...
      "How will profits and losses be shared among the parties?",
      "What are the governance structure and decision-making process for the joint venture?",
    ],
  },
  {
    ...
    questions: [
      ...
      "What is the licensing fee or royalty structure?",
      "What are the termination conditions and dispute resolution mechanisms?",
    ],
  },
  {
    ...
    questions: [
      ...
      "What are the consequences of default, foreclosure, or prepayment?",
      "Are there any escrow arrangements for taxes and insurance?",
    ],
  },
  {
    ...
    questions: [
      ...
      "Are there any quality control measures, warranties, or guarantees?",
      "How will disputes and breaches be resolved, and what are the termination conditions?",
    ],
  },
  {
    ...
    questions: [
      ...
      "What are the pricing, billing methods, and payment terms?",
      "Are there any provisions for emergency repairs, replacements, or upgrades?",
    ],
  },
  {
    ...
    questions: [
      ...
      "What is the pricing structure, including fixed fees or variable costs?",
      "How will confidentiality, data protection, and intellectual property rights be handled?",
    ],
  },
  {
    ...
    questions: [
      ...
      "What is the compensation structure, including commissions or fees?",
      "What are the termination conditions and post-termination obligations?",
    ],
  },
];
